    ...
    >
      <Card className="relative w-full max-w-md border-forge-border bg-forge-surface">
        ...
        <CardHeader>
          ...
          <CardDescription>
            Add USDC on Base (chain {base.id}) via gasless 1Shot relay. Venice x402
            inference draws from this balance.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="rounded-lg border border-forge-info/30 bg-forge-info/10 px-3 py-2 text-xs text-forge-text-muted">
            Bridge USDC to Base if your wallet is on another network, then fund the
